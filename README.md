...
> Изображения находятся в папке `docs/screenshots`. При необходимости замените их своими (имена файлов сохранить).

| Экран                      | Скриншот                                                    |
| -------------------------- | ----------------------------------------------------------- |
| Вход                       | ![Экран входа](docs/screenshots/login.png)                  |
| Список раундов             | ![Список раундов](docs/screenshots/rounds-list.png)         |
| Ожидание старта раунда     | ![Ожидание старта](docs/screenshots/round-waiting.png)      |
| Активный раунд (мобильный) | ![Активный раунд](docs/screenshots/round-active-mobile.png) |
| Завершённый раунд          | ![Завершённый раунд](docs/screenshots/round-finished.png)   |

> Если просматриваете README на GitHub и изображения не отображаются, убедитесь что файлы присутствуют локально. Вы можете добавить свои скриншоты (PNG) разрешением ~1280px шириной (для десктопных) и ~750x1400 (для мобильного) для наилучшего качества.
